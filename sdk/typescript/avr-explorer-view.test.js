...
test("builds a Blockscout-compatible public reference view without raw evidence", () => {
 const presentation = createPresentation(receipt, { level: "commitment-only" }); const view = buildExplorerView(presentation, { mode: "individual", anchor: { blockNumber: 12, blockHash: `0x${"11".repeat(32)}`, transactionHash: `0x${"22".repeat(32)}`, contract: "0xE680eEb44688898c108FAf2bF8589d108Fe86fE8", schemaVersion: "0.1.0-draft" } }, "http://127.0.0.1:4000");
