...
| Historical `--dev` restart profile | Documented legacy limitation | Existing Core-Geth `--dev` database rejected on restart. It is no longer the Phase 3 runner; the replacement custom-genesis runner passed restart/recovery. |

## Completed real-delay trial

The isolated loopback-only VPS trial completed after the real 48-hour wall
interval and matching chain activation condition. It used synthetic accounts
and no user funds. The final public-safe result is recorded in
[the governance-delay evidence](./phase3-governance-delay-evidence-2026-09-13.json)
and retained on the VPS at:

`/tmp/aichain-phase3-hSThJP/repro/devnet/phase3-signoff/governance-finish-report.json`
...
`0x5284d243d0312beb148056fda82497a7405c2f30836620946e2e18f0d56fc08f`

The report SHA-256 is
`eddce66bff446b1986d0354318cb757a5e2608d6ef4e5745fb9f18803d605a76`.
The isolated node was stopped on 2026-09-14. Its disposable guardian-key record
and synthetic private witness were securely removed; the public completion
